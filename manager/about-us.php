...
if (strlen($_SESSION['id']==0)) {
  ...
  if(isset($_POST['submit_contact'])) {
    ...
    $query=mysqli_query($con,"update tblpage set PageTitle='$pagetitle',Email='$email',MobileNumber='$mobnumber',Time='$time',PageDescription='$pagedes' where PageType='contactus'");
    if ($query) {
          ...
          <div class="form-grids row widget-shadow" data-example-id="basic-forms">
            ...
            <div class="form-body">
              <form method="post">
                ...
                <?php } ?>
                <button type="submit" name="submit_about" class="btn btn-default">Update</button>
              </form>
            </div>
          </div>
          <div class="form-grids row widget-shadow" data-example-id="basic-forms">
            ...
            <div class="form-body">
              <form method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="time" id="time" value="<?php echo $row['Time'];?>" required="true">
                </div>
                <?php } ?>
                <button type="submit" name="submit_contact" class="btn btn-default">Update</button>
              </form>
            </div>
          </div>
        </div>
